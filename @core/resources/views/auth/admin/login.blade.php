            ...
            <div class="login-box ptb--100">
                <form method="POST" action="{{ route('admin.login') }}">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            <label for="captcha_answer">{{__('Security check')}}: <strong>{{ session('math_captcha_a', '?') }} + {{ session('math_captcha_b', '?') }}</strong> = ?</label>
                            <input type="number" id="captcha_answer" name="captcha_answer" min="0" required>
                            <i class="ti-shield"></i>
                        </div>
